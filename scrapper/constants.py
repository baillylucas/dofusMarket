...
from user_config import (
    ...
    COORDINATES_ENTRY_COSMETIQUES_TOP_LEFT,
    COORDINATES_ENTRY_COSMETIQUES_BOTTOM_RIGHT,
    COORDINATES_HDV_AMES_TOP_LEFT,
    COORDINATES_HDV_AMES_BOTTOM_RIGHT,
    COORDINATES_ENTRY_AMES_TOP_LEFT,
    COORDINATES_ENTRY_AMES_BOTTOM_RIGHT,
    ...
    COORDINATES_HDV_OWNED_BANK_TOP_LEFT,
    COORDINATES_HDV_OWNED_BANK_BOTTOM_RIGHT,
    COORDINATES_HDV_FIRST_PRICE_TOP_LEFT,
    COORDINATES_HDV_FIRST_PRICE_BOTTOM_RIGHT,
    COORDINATES_HDV_BUY_BTN_TOP_LEFT,
    COORDINATES_HDV_BUY_BTN_BOTTOM_RIGHT,
    # --- Scraper XP Familier : banque ---
    COORDINATES_MAP_BANK,
    COORDINATES_BANK_DOOR_TOP_LEFT,
    COORDINATES_BANK_DOOR_BOTTOM_RIGHT,
    COORDINATES_BANKER_TOP_LEFT,
    COORDINATES_BANKER_BOTTOM_RIGHT,
    COORDINATES_BANK_ACCOUNT_BTN_TOP_LEFT,
    COORDINATES_BANK_ACCOUNT_BTN_BOTTOM_RIGHT,
    COORDINATES_BANK_TAB_EQUIPEMENTS_TOP_LEFT,
    COORDINATES_BANK_TAB_EQUIPEMENTS_BOTTOM_RIGHT,
    COORDINATES_BANK_TAB_CONSOMMABLES_TOP_LEFT,
    COORDINATES_BANK_TAB_CONSOMMABLES_BOTTOM_RIGHT,
    COORDINATES_BANK_TAB_RESSOURCES_TOP_LEFT,
    COORDINATES_BANK_TAB_RESSOURCES_BOTTOM_RIGHT,
    COORDINATES_BANK_TAB_COSMETIQUES_TOP_LEFT,
    COORDINATES_BANK_TAB_COSMETIQUES_BOTTOM_RIGHT,
    COORDINATES_BANK_SEARCH_BOX_TOP_LEFT,
    COORDINATES_BANK_SEARCH_BOX_BOTTOM_RIGHT,
    COORDINATES_BANK_CANCEL_SEARCH_TOP_LEFT,
    COORDINATES_BANK_CANCEL_SEARCH_BOTTOM_RIGHT,
    COORDINATES_BANK_GRID_FIRST_ITEM_TOP_LEFT,
    COORDINATES_BANK_GRID_FIRST_ITEM_BOTTOM_RIGHT,
    BANK_ITEM_PADDING,
    COORDINATES_BANK_HOVER_NAME_TOP_LEFT,
    COORDINATES_BANK_HOVER_NAME_BOTTOM_RIGHT,
    # --- Scraper XP Familier : inventaire ---
    COORDINATES_INVENTORY_TAB_EQUIPEMENTS_TOP_LEFT,
    COORDINATES_INVENTORY_TAB_EQUIPEMENTS_BOTTOM_RIGHT,
    COORDINATES_INVENTORY_TAB_CONSOMMABLES_TOP_LEFT,
    COORDINATES_INVENTORY_TAB_CONSOMMABLES_BOTTOM_RIGHT,
    COORDINATES_INVENTORY_TAB_RESSOURCES_TOP_LEFT,
    COORDINATES_INVENTORY_TAB_RESSOURCES_BOTTOM_RIGHT,
    COORDINATES_INVENTORY_TAB_COSMETIQUES_TOP_LEFT,
    COORDINATES_INVENTORY_TAB_COSMETIQUES_BOTTOM_RIGHT,
    COORDINATES_INVENTORY_SEARCH_BOX_TOP_LEFT,
    COORDINATES_INVENTORY_SEARCH_BOX_BOTTOM_RIGHT,
    COORDINATES_INVENTORY_CANCEL_SEARCH_TOP_LEFT,
    COORDINATES_INVENTORY_CANCEL_SEARCH_BOTTOM_RIGHT,
    COORDINATES_INVENTORY_GRID_FIRST_ITEM_TOP_LEFT,
    COORDINATES_INVENTORY_GRID_FIRST_ITEM_BOTTOM_RIGHT,
    INVENTORY_ITEM_PADDING,
    COORDINATES_INVENTORY_HOVER_NAME_TOP_LEFT,
    COORDINATES_INVENTORY_HOVER_NAME_BOTTOM_RIGHT,
    # --- Scraper XP Familier : familier ---
    COORDINATES_PET_TOP_LEFT,
    COORDINATES_PET_BOTTOM_RIGHT,
    COORDINATES_PET_FEED_BTN_TOP_LEFT,
    COORDINATES_PET_FEED_BTN_BOTTOM_RIGHT,
    COORDINATES_PET_FEED_SLOT_TOP_LEFT,
    COORDINATES_PET_FEED_SLOT_BOTTOM_RIGHT,
    COORDINATES_PET_XP_GIVEN_TOP_LEFT,
    COORDINATES_PET_XP_GIVEN_BOTTOM_RIGHT,
    COORDINATES_PET_QTY_GIVEN_TOP_LEFT,
    COORDINATES_PET_QTY_GIVEN_BOTTOM_RIGHT,
    COORDINATES_PET_FEED_CLOSE_TOP_LEFT,
    COORDINATES_PET_FEED_CLOSE_BOTTOM_RIGHT,
    # --- Scraper XP Familier : paramètres ---
    MAX_PRICE_FAMILIER,
)
...
FOLDER_IMAGE_PATH_XP = os.path.join("screenshoots_xp")  # Dossier dédié au scraper XP familier
