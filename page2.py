...
def header_id_clicked():
    print("Clic sur colonne ID")

def header_nom_clicked():
    print("Clic sur colonne Nom")

def header_niveau_clicked():
    print("Clic sur colonne Niveau")

def header_supertype_clicked():
    print("Clic sur colonne Supertype")

def header_type_clicked():
    print("Clic sur colonne Type")

def header_craft_clicked():
    print("Clic sur colonne Craft")

def header_prix_hdv_clicked():
    print("Clic sur colonne Prix HDV")

def header_cout_craft_clicked():
    print("Clic sur colonne Coût Craft")
...
with col_header_content:
    ...
    with header_cols[1]:
        st.button("ID", key="btn_header_id", on_click=header_id_clicked)
    
    with header_cols[2]:
        st.button("Nom", key="btn_header_nom", on_click=header_nom_clicked)
    
    with header_cols[3]:
        st.button("Niveau", key="btn_header_niveau", on_click=header_niveau_clicked)
    
    with header_cols[4]:
        st.button("Supertype", key="btn_header_supertype", on_click=header_supertype_clicked)
    
    with header_cols[5]:
        st.button("Type", key="btn_header_type", on_click=header_type_clicked)
    
    with header_cols[6]:
        st.button("Craft", key="btn_header_craft", on_click=header_craft_clicked)
    
    with header_cols[7]:
        st.button("Prix HDV", key="btn_header_prix_hdv", on_click=header_prix_hdv_clicked)
    
    with header_cols[8]:
        st.button("Coût Craft", key="btn_header_cout_craft", on_click=header_cout_craft_clicked)
