...
# def create_type_files(json_filename="data/dofus_items.json", levels=None, l_types=None, l_supertypes=None, only_craft=True):
#     """
...
#                (not l_supertypes or item['supertype'] in l_supertypes)
#         }
...
#     # Liste les items à scrapper dans les fichiers 'consommables.txt', 
#     # 'equipements.txt', 'forgemagies.txt' et 'ressources.txt' du dossier 'data'
#     # create_type_files(
#     #     levels=[1, 200],
#     #     l_supertypes=["Arme"],
#     #     only_craft=True
