...
page_familier_test = st.Page("pages/familier_test.py", title="Familiers Test", icon="🔍")
...
pg = st.navigation([page_prices, page_groups, page_scrapper, page_achat_revente, page_familier, page_bashing, page_familier_test])
