...
if len(df_page) > 0:
    ...
    # Calculer une hauteur initiale généreuse : 60px par ligne + marge pour les expanders
    initial_height = len(df_page) * 60 + 500
    
    # Utiliser une hauteur initiale importante qui sera ajustée dynamiquement
    components.html(all_html, height=initial_height, scrolling=False)
else:
